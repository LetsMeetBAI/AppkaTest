...
function showevents1(){
	...
	dbRefObject.on('child_added', snap =>{
		...
		$("#tabelka").append("<tr><td>" + eventtitle + "</td><td>" + eventemail + "</td><td>" + eventUserName +"</td><td>" 
		+ eventDate +"</td><td>" + eventDateTime +"</td><td>" + eventLocation + "</td><td>" + eventPhone +"</td><td>" + eventLink +'</td><td><button onclick="attendevent()">Weź udział</button></td></tr>');
		//window.alert("no elo");
	});
